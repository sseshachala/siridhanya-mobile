...
class CancerDietItemsAdapter(private val context: Context, private var myDataset: ArrayList<MilletCancerDietData>) :
    RecyclerView.Adapter<CancerDietItemsAdapter.CancerDietViewHolder>() {


    var arraylist: ArrayList<MilletCancerDietData> = ArrayList(myDataset)
